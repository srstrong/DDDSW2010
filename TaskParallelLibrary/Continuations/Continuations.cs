...
namespace Continuations
{
    class Continuations
    {
        ...
        private static void ContinueWithExceptions()
        {
            ...
            var task2 = task.ContinueWith(t => Console.WriteLine("Request successful"),
                                          TaskContinuationOptions.OnlyOnRanToCompletion);

            var task3 = task.ContinueWith(t => Console.WriteLine("Task failed: {0}", t.Exception), TaskContinuationOptions.OnlyOnFaulted);
            ...
            task.DisplayState("task1");
            task2.DisplayState("task2");
            task3.DisplayState("task3");
        }
    }
